# LESSON PLAN: SESSION 15 – INTEGRATION TESTING & CODE AUDIT
...
> *"Chào các bạn. Hôm nay là buổi cuối cùng trước khi chúng ta tốt nghiệp Phase 1.
> Hãy tưởng tượng chúng ta là những kỹ sư của Boeing.
> Code xong **chưa phải là xong**. Máy bay phải bay thử.
> Hôm nay chúng ta sẽ làm 3 việc:"*
>
...
> *"Nhiều bạn code xong vứt đó. 6 tháng sau mở lại không nhớ chạy kiểu gì.
> Hoặc người khác vào team đọc code không hiểu.
> Buổi này dạy kỹ năng **hoàn thiện sản phẩm**."*
...
* Hôm nay ta làm **Manual E2E Testing** – *chạy bằng cơm*.
...
> *"Buổi này ta học **tư duy test**.
> Chưa học test tự động (Cypress / Playwright).
> Vì nếu test tay còn sai → test tự động cũng sai."*
...
> *"Mở 2 cửa sổ: App + Checklist.
> Tick từng mục. Fail ở đâu ghi chú ngay."*
